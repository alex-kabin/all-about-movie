...
&#13;
Genre: <xsl:apply-templates select="Genres"/>
&#13;
Runtime: <xsl:apply-templates select="Runtime"/>
&#13;
Director: <xsl:apply-templates select="Directors" />
&#13;
Actors: <xsl:apply-templates select="Actors" />
&#13;
Storyline: <xsl:value-of select="Storyline" />
&#13;
Rating: <xsl:apply-templates select="Ratings/Rating" />
